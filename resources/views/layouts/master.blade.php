...
<div class="navbar navbar-inverse navbar-fixed-top navbar-lg" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{url("/")}}">Relief Supports</a>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li {{ (Request::is('/') ? 'class=active' : '') }}><a href="{{url("/")}}">මුල් පිටුව </a></li>
                <li {{ (Request::is('donations*') ? 'class=active' : '') }}><a href="{{url("/donations")}}">ආධාර</a></li>
                <li {{ (Request::is('needs*') ? 'class=active' : '') }}><a href="{{url("/needs")}}">අවශ්‍යතාවයන්</a></li>
                <li {{ (Request::is('emergency-contacts*') ? 'class=active' : '') }}><a href="{{url("/emergency-contacts")}}">අත්‍යවශ්‍ය දුරකථන  අංක </a></li>
                <li {{ (Request::is('online-donations*') ? 'class=active' : '') }}><a href="{{url("/online-donations")}}">Online Donations </a></li>
                <li {{ (Request::is('twitter-feed*') ? 'class=active' : '') }}><a href="{{url("/twitter-feed")}}">#FloodSL Twitter Feed</a></li>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
</div>
